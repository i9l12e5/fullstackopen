...
sequenceDiagram
    ...
    Note left of browser: .container { padding: 10px; border: 1px solid } .notes { color: blue; }
    ...
    Note left of browser: 0	Object { content: "second note", date: "2024-11-11T17:32:05.537Z" } 1   Object { ... } ...
